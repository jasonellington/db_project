  ...
  <form action="compute-grade-to-file.php" method="post">  
    <fieldset style="padding:5px; width:50%; align:middle;">  
      ...
      <table >
        <tr>
          <td>
            Username: <input type="text" name="prj1" size="10px" placeholder="jason123"/> 
            Password: <input type="text" name="prj2" size="10px" placeholder="password"/>          
...
<?php
   ...
   $filename = "/Applications/XAMPP/xamppfiles/htdocs/cs4750/db_project/data/register.txt";    
...
//          echo "File exists";
      ...
      $file = fopen($filename, "a");      // if the file doesn't exist, create a new file             // set permission. 
