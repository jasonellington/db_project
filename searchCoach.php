	...
	<script>
  	$(document).ready(function() {
  		$( "#LastNinput" ).change(function() {
  			...
  			$.ajax({
  				url: 'SearchCoachName.php', 
  				data: {searchCoach: $( "#LastNinput" ).val()},
...
<div class="container">
  <h3>Search substring of a Coach Last Name</h3>	

  <div class="input-group">
    <input class="form-control" id="LastNinput" type="search" size="30" placeholder="Coach Name Contains"/>
  </div>
