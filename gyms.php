<?php
 ...
 $sql="SELECT * FROM gyms ORDER BY gym_name";
...
<div class="container">
  <h2>Gyms Table</h2>
  <p>This is a table of the gyms of the top 25 teams.</p>
  <p>*Click on the table headers to sort by a specific column.</p> 
  <a href="gyms.xml" class="btn btn-primary" role="button" download>Download XML</a>                          
