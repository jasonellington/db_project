...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Delete Coach</li>
</ol>
</div>

<div class="container">
  <h2>Delete a Coach to the Coach's Table</h2>
  <BR>
...
<div class="container">
  <h3>Search lastname for coach to delete</h3>	

  <div class="input-group">
    <input class="form-control" id="LastNinput" type="search" size="30" placeholder="Coach Last Name Contains"/>
  </div>
