...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Delete Player</li>
</ol>
</div>

<div class="container">
  <h2>Delete a Player to the Player's Table</h2>
  <BR>
...
<div class="container">
  <h3>Search lastname for player to delete</h3>	

  <div class="input-group">
    <input class="form-control" id="LastNinput" type="search" size="30" placeholder="Player Last Name Contains"/>
  </div>
